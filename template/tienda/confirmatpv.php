...
$urlOK="http://www.mo-el.es/tienda/trans_autorizada.php?order=$id_comanda&jsid=$jsid";
$urlKO="http://www.mo-el.es/tienda/trans_denegada.php?order=$id_comanda&jsid=$jsid";
$id=time();
$amount=$total;
...
?>
<form class="form-horizontal" name="frm" action="https://sis.redsys.es/sis/realizarPago" method="POST">
