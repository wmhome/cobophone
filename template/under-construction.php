...
<div class="page-box" style="min-height: auto;">
  ...
  <div class="container">
    <div class="row">
      <div class="text-center col-sm-12 col-md-12">
		...
		<p>
			Trabajamos para mejorar nuestros servicios, subscríbete a nuestro newsletter para estar al día de todas nuestras novedades! Disculpen las moléstias.
		</p>
		<br><br>
	  </div>
	  <!--
	  <div class="coming-text col-sm-12 col-md-4">
		<form class="subscribe-form" method="post" action="php/subscribe.php">
		  <span class="form-message success" style="display: none;"></span>
		  <input class="form-control email" type="email" name="subscribe" placeholder="Escribe tu email...">
		  <button type="submit" class="btn btn-default submit">Enviar</button>
		</form>
		<br><hr><br>
	  </div>
	  -->
	  <div class="col-sm-12 under-contact">
		<div class="row">
		  <div class="phone col-sm-6 col-md-6">
			...
			<strong>Llámanos:</strong> <a href="tel://+34916422257">+34 916 422 257</a> <br>
