    ...
    <div class="page-box-content">
        ...
        <section id="main">
            <header class="page-header">
                <div class="container">
                    <h1 class="title">Tarifas reparaciones</h1>
                </div>
            </header>
            <div class="container">
                <div class="row">
                    <article class="content col-sm-12 col-md-12">
                        <h2 class="text-center">Esta sección está en construcción, disculpe las moléstias.<br>Si quiere conocer el precio de su reparación, porfavor rellene el formulario de presupuesto estimado apretando el botón verde de presupuesto o llamenos al +34 916 422 257, también puede realizar su llamada a través de skype en el botón azul "Llámenos".<br>Muchas gracias por confiar en CoboPhone.</h2>
